...
# set(GccCompailParam "${GccCompailParam} -fsanitize=address") # AddressSanitizer 内存泄露检测 
# set(GccCompailParam "${GccCompailParam} -fsanitize=leak ") # LeakSanitizer 内存泄露检测
...
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} ${GccCompailParam} -g")
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} ${GccCompailParam} -g")

set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} ${GccCompailParam} -O2 -DNDEBUG")
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} ${GccCompailParam} -O2 -DNDEBUG")
