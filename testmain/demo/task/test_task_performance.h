...
class CTestTask3 : public Arrow::Pattern::TaskOneThread3<CTestTask3>
{
public :
    CTestTask3() {}
    virtual ~CTestTask3()
    {
        Arrow::Pattern::TaskOneThread3<CTestTask3>::Stop();
