...
void test_typelist_type()
{
    ...
    typedef typename Arrow::tlist::FindLast<int, typelist_type6> typelist_type7;
...
void test_typelist_vlaue()
{
    ...
    std::cout << Arrow::tlist::Find<Arrow::IntValueType<5>, typelist_value1>::value << std::endl;

    std::cout << Arrow::tlist::Find<Arrow::IntValueType<6>, typelist_value1>::value << std::endl;
...
void TestPair()
{
    ...
    typedef  Arrow::static_map<
     ...
     Arrow::tlist::print(SMap1::get<Arrow::IntValueType<6>>{});
